...
class Model:
    ...
    #     self.dialog = MDDatePicker(min_year=2000, max_year=2022)
    #     self.dialog.bind(on_save=self.set_last_appointment_date)
    #     self.dialog.open()
    # def set_last_appointment_date(self, instance, value, date_range):
    #     self.last_appointment_date = str(value)
    #     print(self._last_appointment_date)
    ...
    def return_last_app_date(self):
        return str(self.last_appointment_date)
